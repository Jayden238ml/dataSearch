...
<%
	...
	if ("".equals(dataMap.getString("SESSION_USER_ID")) || !"SMC".equals(dataMap.getString("SESSION_USER_TYPE"))) {
...
<div id="header-mobile">
	...
	<div class="total-bg">&nbsp;</div>
		...
		<div class="total-list">
			<ul class="hm-menu">
				<li class="hm-sub sub-depth1"><a href="#"><span>문자발송</span> <i class="ion-android-add" aria-hidden="true"></i></a>
				<ul>
					<li class="sub-depth2"><a href="javascript:fnMobileClickTopMenu('/Sms/Main.do');"><span>문자발송</span></a></li>
				</ul>
			</ul>
		</div>
	</div>
