...
<body id="user">
	<div id="wrap">
			<%@ include file="/static_root/inc/sms_header.jsp" %>
		<ul id="content">
			<li id="left">
				<!-- 좌측영역 -->
				<%@ include file="/static_root/inc/sms_left.jsp" %>
				<!-- 좌측영역 끝 -->
			</li>
			<li id="right">
				<!-- 타이틀/네비 -->
				<div class="titleNaviNew">
					<h3 class="subTitle">문자발송</h3>
				</div>
				<!-- 타이틀/네비 끝 -->
				<div id="cont">
...
<!-- 								</div> -->
						...
						<dl class="titleEaB">
							<dt>
								현재 잔액&nbsp; :&nbsp;  <strong><fmt:formatNumber value="0" pattern="#,###"/></strong> 원&nbsp;
							</dt>
							<dd>
