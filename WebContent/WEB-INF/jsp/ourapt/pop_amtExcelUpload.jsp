			...
			$.ajax({
				...
				success: function (transport){
					if(transport.ERROR_CD == "999"){
						...
						return;
					}else if(transport.ERROR_CD == "404"){
						alert("업로드 된 Excel 자료분석 중 오류가 발생하였습니다.");
						return;
					}else{
	...
	<div class="layerWrap500 pop_inner_wrap" style="display:block;">
		...
		<div class="popArea">
			<form name="popFrm" id="popFrm" method="post" action="#">
				...
				<fieldset>
					<legend>회비내역 업로드</legend>
					<h2 class="title2">회비내역 업로드</h2>
					<div class="tableView">
						<table summary="회비내역 업로드">
							<caption>회비내역 업로드</caption>
							<colgroup>
								<col width="22%" />
								<col width="*" />
							</colgroup>
							<tr>
								<th>양식 다운로드</th>
								<td>
									<a href="/static_root/common/DuesUplod.xlsx" target="Pop_excelFormDown" class="btn3 w80">다운로드</a>
								</td>
							</tr>
							<tr>
								<th>첨부파일</th>
