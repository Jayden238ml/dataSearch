...
<!-- 						<div class="tx-menu-inner"> </div>  -->
						<div class="tx-menu-footer"> 
							<img class="tx-menu-confirm" src="/static_root/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/> 
							<img class="tx-menu-cancel" hspace="3" src="/static_root/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/> 
						</div> 
					</div> 
				</li> 
<!-- 				<li class="tx-list">  -->
...
<!-- 			</ul>  -->
		...
		<div class="tx-toolbar-boundary"> 
			...
			<ul class="tx-bar tx-bar-left tx-group-align"> 
				...
				<li class="tx-list"> 
					...
					</div> <div id="tx_cellsoutline_menu" class="tx-cellsoutline-menu tx-menu" unselectable="on"></div> 
				</li> 
			</ul> 
			<ul class="tx-bar tx-bar-left"> 
				<li class="tx-list"> 
	...
	<!-- 툴바 - 더보기 끝 --> <!-- 편집영역 시작 --> <!-- 에디터 Start --> 
	<div id="tx_canvas" class="tx-canvas"> 
		<div id="tx_loading" class="tx-loading">
<!-- 			<div> -->
<!-- 				<img src="/static_root/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/> -->
<!-- 			</div> -->
		</div> 
	...
	<div id="tx_resizer" class="tx-resize-bar"> 
		...
		<img id="tx_resize_holder" src="/static_root/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" /> 
	</div> 
		...
		<div id="tx_attach_box" class="tx-attach-box"> 
			<div class="tx-attach-box-inner"> 
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p>
					<img src="/static_root/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/>
				</div> 
