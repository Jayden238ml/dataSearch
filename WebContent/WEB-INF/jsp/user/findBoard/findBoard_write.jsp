...
<head>
	...
	<meta name="title" content="찾아주세요" />
	<meta name="description" content="커뮤니티 찾아주세요" />
	...
	<meta property="og:description" content="찾아주세요 " />
	
	<title>애니멀허그 | 커뮤니티 | 찾아주세요</title>
...
//                       ['Misc', ['fullscreen']]
	...
	function fnMove(){
		$('#boardFrm').attr("action", "/user/Board/findBoard.do").submit();
	}
...
<body>
	<div id="wrap">
		...
		<div id="content">
			...
			<input type="hidden" name="FIND_SEQ" id="FIND_SEQ" value="<c:out value='${INIT_DATA.FIND_SEQ}' />">
			<!-- 타이틀 -->
...
<!-- 						<legend>게시판</legend> -->
					<div class="member-write">
						<ul>
							...
							<li>
								<span style="color:blue;">품종 / 특징 / 잃어버린 장소 / 사진 / 연락처 등 상세히 적어주시면 됩니다.</span>
							</li>
							<li>
								<div>
