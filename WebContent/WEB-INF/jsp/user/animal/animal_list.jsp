...
<meta name="title" content="유기동물조회" />
<meta name="description" content="유기동물조회" />
...
<meta property="og:description" content="유기동물조회 " />

<title>애니멀허그 | 유기동물 | 유기동물조회</title>
	...
	<body>
		<div id="wrap">
			...
			<div id="content">
				...
				<form name="frm"  id="frm" method="post" action="/user/animal/findAnimal.do">
				...
				<input type="hidden" name="RTN_URL"		id="RTN_URL"	value="/user/animal/findAnimal.do"/>
				...
				<div class="insight-list">
					<p class="list-total">※ 조회되는 데이터는 <span style="color:red">동물보호시스템</span>에서 제공받은 데이터 이며 기간은 현재일 기준으로 <span style="color:red">2주 전</span> 이며 
					상태는 <span style="color:red">공고중</span>인 데이터만 조회 됩니다. <span style="color:red">(입양불가)</span> </p>
					<br/>
					<div class="videoList">
						<ul>
